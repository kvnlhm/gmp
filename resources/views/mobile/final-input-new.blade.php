...
@section('mobile-content')
    <div class="mobile-app">
        ...
        <div class="app-content">
            <form action="{{ route('mobile.final.input.save.new', $monitoring->id) }}" method="POST" class="input-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="tekanan" class="form-control" name="tekanan" step="0.01" value="{{ $lastMonitoring->tekanan ?? '' }}" required>
                </div>

                <div class="form-group">
                    <label for="laporan">Laporan</label>
                    <textarea id="laporan" class="form-control" name="laporan" required>{{ $lastMonitoring->laporan ?? '' }}</textarea>
                </div>
