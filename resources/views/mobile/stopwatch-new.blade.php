...
@section('mobile-content')
    ...
    <div class="mobile-app">
        <div class="app-header">
            <div class="header-title" id="timerTitle">T1 Move to the Point</div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const baseUrl = '{{ url('/') }}';
            let monitoringId = new URLSearchParams(window.location.search).get('id');
            ...
            async function saveTime() {
                ...
                try {
                    ...
                    if (monitoringId) {
                        requestBody.monitoring_id = monitoringId;
                    }

                    const response = await fetch('/gmp/mobile/monitoring/update-time-new', {
                        method: 'POST',
                        headers: {
                    ...
                    // Update monitoringId jika baru dibuat
                    if (!monitoringId && result.monitoring_id) {
            ...
            async function finishMonitoring() {
                try {
                    ...
                    // Redirect ke halaman final input new
                    window.location.href = `${baseUrl}/mobile/final-input-new/${monitoringId}`;
                } catch (error) {
                    console.error('Error:', error);
                    alert('Terjadi kesalahan: ' + error.message);
                }
