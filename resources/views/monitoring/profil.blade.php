...
@section('breadcrumb')
    <div class="page-title d-flex flex-column me-5 py-2">
        <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Halaman Profil</h1>
...
@section('konten')
<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="POST" action="{{ url('user/profil/update') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{ asset('public/storage/images/user/' . $user->foto) }})"></div>
                ...
                <div class="text-muted fs-7">Atur foto profil. Hanya file gambar *.png, *.jpg dan *.jpeg yang dapat diterima</div>
            </div>
        </div>
        @if (Auth::user()->id_priv == 1)
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <select class="form-select mb-2" name="id_priv" data-control="select2" data-hide-search="true" data-placeholder="Pilih Hak Akses" id="pilih_hak_akses" onchange="updateHakAksesIndicator(this.value)">
                        <option></option>
                        <option value="1" {{ $user->id_priv == 1 ? 'selected' : '' }}>Admin</option>
                        <option value="2" {{ $user->id_priv == 2 ? 'selected' : '' }}>Pengguna</option>
                    </select>
                </div>
            </div>
        @endif
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
            <li class="nav-item">
                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#umum">Informasi Umum</a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name" class="form-control mb-2" placeholder="Username" value="{{ $user->name }}" required />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="nama_lengkap" class="form-control mb-2" placeholder="Nama Lengkap" value="{{ $user->nama_lengkap }}" required />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="number" name="no_telp" class="form-control mb-2" placeholder="No. Telepon" value="{{ $user->no_telp }}" required minlength="10"
                                maxlength="13" min="0" />
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="password" name="password_confirmation" class="form-control mb-2" placeholder="•••••••••••" />
